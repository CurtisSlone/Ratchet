...
# NOTE: pending update - new_project now scaffolds workspaces\<name> (not out\<name>); the project
# tools' bare-name resolution + the out\ assertions below need realigning to workspaces\ before this passes.
$name = "__smoke__"
$pass = 0; $fail = 0
