...
# This script lives in scripts\windows\, so the sibling RatchetBox repo is three levels up.
$inst = Join-Path (Split-Path -Parent $MyInvocation.MyCommand.Path) "..\..\..\RatchetBox\Windows\dotnet4-x"
$name = "__smoke__"
$pass = 0; $fail = 0
