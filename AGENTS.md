...
| How and why it works | [Architecture](docs/concepts/architecture.md), [Context Binding](docs/concepts/context-binding.md), [Composition](docs/concepts/composition.md), [Methodologies](docs/concepts/methodologies.md), [Observability](docs/concepts/observability.md) ([run record schema](docs/concepts/run-record.md)) |
